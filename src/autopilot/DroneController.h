...
private:
	...
	void calcControl(TooN::Vector<4> new_err, TooN::Vector<4> d_error, double yaw, double maxControlFactor);
...
public:
	...
	ControlCommand update(tum_ardrone::filter_stateConstPtr, double maxControlFactor);
